# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-05-22 10:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantity', models.IntegerField(default=1, validators=[django.core.validators.MinValueValidator(1)])),
                ('condition', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='xwingdata.Condition')),
        ...
        migrations.AddField(
            model_name='source',
            name='conditions',
            field=models.ManyToManyField(through='xwingdata.SourceCondition', to='xwingdata.Condition'),
        ),
        migrations.AddField(
            model_name='source',
            name='pilots',
        ...
        migrations.AlterUniqueTogether(
            name='sourcecondition',
            unique_together=set([('source', 'condition')]),
        ),
        migrations.AlterUniqueTogether(
            name='ship',
            unique_together=set([('name',)]),
