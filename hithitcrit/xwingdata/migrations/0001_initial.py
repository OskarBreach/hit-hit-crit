# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-04-23 16:15
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('name', models.CharField(max_length=255, unique=True)),
                ('url_name', models.CharField(max_length=255, unique=True, validators=[django.core.validators.RegexValidator(regex='^[a-z0-9\\-]+$')])),
